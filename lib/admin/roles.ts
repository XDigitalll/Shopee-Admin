...
export const ROUTE_ACCESS_RULES: Array<{
  ...
  { pattern: /^\/admin\/catalog\/products$/, module: "products" },
  { pattern: /^\/admin\/catalog\/categories$/, module: "categories" },
  { pattern: /^\/admin\/catalog\/brands$/, module: "products" },
  { pattern: /^\/admin\/catalog\/promotions$/, module: "products" },
