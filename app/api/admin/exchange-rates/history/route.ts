...
export async function GET(request: NextRequest) {
  ...
  return relayExchangeRateResponse(
    request,
    `/admin/exchange-rates/history?baseCurrency=${encodeURIComponent(baseCurrency)}&targetCurrency=${encodeURIComponent(targetCurrency)}`,
    {},
    "Nao foi possivel carregar o historico de cambio.",
  );
}
